...
tipTemplate = Handlebars.templates["common/tip_and_alert/frontend_templates/tip"]
alertTemplate = Handlebars.templates["common/tip_and_alert/frontend_templates/alert"]
