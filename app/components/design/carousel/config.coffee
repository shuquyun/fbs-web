...
module.exports = ->
  ...
  @registerConfigProperty "ext", heightProperty, superProperty, indicatorProperty, typeProperty, controlProperty, imageCountProperty, injectImageProperty, intervalProperty
