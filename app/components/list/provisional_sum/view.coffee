itemModalTemplate = Handlebars.templates["list/provisional_sum/frontend_templates/modal"]
trTemplate = Handlebars.templates["list/provisional_sum/all_templates/tr"]

Modal = require "pokeball/components/modal"
FeeSum = require 'list/fee_sum/view'

class ProvisionalSum
  constructor: ->
    @bindEvent()
