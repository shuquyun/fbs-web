itemModalTemplate = Handlebars.templates["list/total_fee/frontend_templates/modal"]
trTemplate = Handlebars.templates["list/total_fee/all_templates/tr"]
